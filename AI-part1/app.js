...
const healthPlan  = require("./controllers/healthPlanController");
const healthPlanJson  = require("./controllers/healthPlanJsonController");
...
app.post('/api/healthPlan', healthPlan );
app.post('/api/healthPlanJson', healthPlanJson);
